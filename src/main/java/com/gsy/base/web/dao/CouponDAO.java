...
public interface CouponDAO {
    ...
    @Insert("INSERT INTO coupon_user_rel (user_openId, couponId, create_time, used_flag) SELECT #{openId}, id, NOW(), 0 FROM coupon WHERE code_name = #{coupon}")
    int inserNewCouponRel(@Param("openId") String openId,@Param("coupon") String coupon);
    ...
    */
    ...
    @Select("SELECT\n" +
            ...
            "\tcoupon_user_rel\n" +
            "WHERE\n" +
            "\tuser_openId = #{openId} AND used_flag != 1 AND delete_flag !=1")
